defmodule PentoWeb.Admin.SurveyResults do
  ...
  defp assign_dataset(
         %{assigns: %{products_with_average_ratings: products_with_average__ratings}} = socket
       ) do
    socket
    |> assign(:dataset, make_bar_chart_dataset(products_with_average__ratings))
  end
