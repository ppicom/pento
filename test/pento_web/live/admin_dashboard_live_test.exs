defmodule PentoWeb.AdminDashboardLiveTest do
  ...
  @create_user_attrs %{email: "test@test.com", password: "12characters", username: "test"}
  @create_user2_attrs %{email: "test2@test.com", password: "12characters", username: "testTwo"}
  @create_user3_attrs %{email: "test3@test.com", password: "12characters", username: "testThree"}
